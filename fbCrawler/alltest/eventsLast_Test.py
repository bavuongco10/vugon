...
#        driver.find_element_by_name("login").click()
    ...
    def _events(self,driver,id):
        driver.get("https://m.facebook.com/timeline/app_collection/?collection_token="+id+"%3A2344061033%3A60")
...
#            return
        ...
        try:
            ...
            while(True):
                subDriver1=driver.find_elements_by_xpath("//*/div[contains(@id,'60:')]")
        ...
        print("EventsLast_"+id+":"+str(len(data)))
